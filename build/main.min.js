        ...
        var o = e("./ReactComponentEnvironment"),
            ...
            C = {
                ...
                mountComponent: function(e, t, n) {
                    ...
                    var p, d = c.currentlyMountingInstance;
                    c.currentlyMountingInstance = this;
                    try {
                        i.componentWillMount && (i.componentWillMount(), this._pendingStateQueue && (i.state = this._processPendingState(i.props, i.context))), p = this._renderValidatedComponent()
                    } finally {
                ...
                _updateRenderedComponent: function(e, t) {
                    ...
                    if (y(r, o)) f.receiveComponent(n, o, e, this._processChildContext(t));
                        ...
                        var s = f.mountComponent(this._renderedComponent, a, e, t);
            ...
            _updateDOMProperties: function(e, t) {
                ...
                for (n in i) {
                    ...
                    if (i.hasOwnProperty(n) && c !== l)
                        if (n === b)
                            if (c && (c = this._previousStyleCopy = m({}, c)), l) {
    ...
    156: [function(e, t, n) {
        var r = e("react"),
            o = r.createClass({
                ...
                showWelcomeMsg: function() {
                    this.addHistory("I'm Prakhar Srivastav and I'll be joining Columbia university this fall in the Computer Science department."), this.addHistory("Type `help` to see what all commands are available")
                },
                catFile: function(e) {
                    "README.md" === e ? (this.addHistory("### REACT TERM"), this.addHistory("A couple of days back, I got an email from Columbia (the university that I'm stated to join) informing me that my new email ID and other student IT services were ready. Hosting my own webpage on a university's domain had long been a wish of mine, so as soon as I learnt about having some server space on the university's server I got excited wanted to put something interesting. Since I already have a boring about me page, I went with something different and built a simple terminal emulator in React!"), this.addHistory("type `source` to view the source code")) : this.addHistory("cat: " + e + ": No such file or directory")
                },
                openLink: function(e) {
                    return function() {
                ...
                showHelp: function() {
                    this.addHistory("help - this help text"), this.addHistory("github - view my github profile"), this.addHistory("source - browse the code for this page"), this.addHistory("intro - print intro message"), this.addHistory("blog - read some stuff that I've written"), this.addHistory("clear - clear screen"), this.addHistory("cat - print contents of a file"), this.addHistory("ls - list files")
                },
                componentDidMount: function() {
                    var e = this.refs.term.getDOMNode();
